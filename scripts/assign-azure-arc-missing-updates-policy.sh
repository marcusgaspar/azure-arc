...
usage() {
  cat <<'USAGE'
Usage:
  assign-azure-arc-missing-updates-policy.sh --scope <scope> --policy-definition-id <id> [--assignment-name <name>] [--location <location>]
USAGE
}
...
echo "Creating/updating policy assignment '$assignment_name' for Azure Arc missing updates..."
cmd=(
