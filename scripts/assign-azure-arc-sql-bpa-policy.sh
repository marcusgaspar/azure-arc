...
usage() {
  cat <<'USAGE'
Usage:
  assign-azure-arc-sql-bpa-policy.sh --scope <scope> --policy-definition-id <id> [--assignment-name <name>] [--location <location>]
USAGE
}
...
echo "Creating/updating policy assignment '$assignment_name' for Azure Arc SQL BPA..."
cmd=(
